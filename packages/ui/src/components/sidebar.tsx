...
import {
	...
	TooltipContent,
	TooltipTrigger,
} from "@berean-study/ui/components/tooltip";
import { useIsMobile } from "@berean-study/ui/hooks/use-mobile";
...
function SidebarProvider({
	...
	const setOpen = useCallback(
		(value: boolean | ((value: boolean) => boolean)) => {
			...
			// biome-ignore lint/suspicious/noDocumentCookie: biome-ignore lint: false positive
